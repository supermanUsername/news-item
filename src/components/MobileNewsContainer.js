        ...
        <TabPane tab="头条" key="top">
          <div style={{width: "100%"}}>
            <Carousel autoplay infinite>
              <div className="carousel"><img src={carousel_1}/></div>
              <div className="carousel"><img src={carousel_2}/></div>
              <div className="carousel"><img src={carousel_3}/></div>
              <div className="carousel"><img src={carousel_4}/></div>
            </Carousel>
          </div>
